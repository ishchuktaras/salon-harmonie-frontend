      ...
      <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="vas.email@salon-harmonie.cz"
                  value={email}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="border-stone-300 focus:border-amber-500 focus:ring-amber-500 pr-10"
                  />
                  <Button
                    type="button"
                    variant="ghost"
              ...
              <div className="space-y-2">
                ...
                <Select value={role} onValueChange={setRole}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="receptionist">Recepční</SelectItem>
                  </SelectContent>
                </Select>
              </div>
        ...
        <Card className="mt-4 border-amber-200 bg-amber-50/50">
          <CardContent className="pt-4">
            <p className="text-sm text-amber-800 font-medium mb-2">Demo přihlašovací údaje:</p>
            <p className="text-xs text-amber-700">
              Email: admin@salon-harmonie.cz
              <br />
              Heslo: admin123
              <br />
              Role: Administrátor
