...
export default function RegisterPage() {
  ...
  const handleAppleLogin = async () => {
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Chyba při Apple registraci")
    }
  }
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Chyba při Google registraci")
    }
  }
